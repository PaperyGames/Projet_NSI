...
class Level1():
    ...
    def Pause_screen(self):
        ...
        while True:
            ...
            self.screen.blit(pygame.transform.scale(MenuPause, (1600,1100)), (217,0))
            ...
            if self.pos[0] > 501 and self.pos[1] > 271 and self.pos[0] < 1459 and self.pos[1] < 787:
    ...
    def main(self):
        ...
        self.dino3 = rex(5850,900,150,150,6990)
        self.dino4 = rex(7000,730,150,150,8000)
        ...
        self.bloc4 = sol(5700,675,2.2,5.6,"bloc",False)
        self.bloc5 = sol(3900,760,1.1,1.1,"bloc",True)
        self.champi1 = objet(415,760,"Champi")
        self.champi2 = objet(3900,760,"Champi")
        self.drapeau = objet(8000,172,"Drapeau")
        self.continuer = True
        #Sounds 
        ...
        while self.continuer:
            ...
            if not self.player.mort and not self.Pause and not self.drapeau.consomme:
                if self.player.hitbox[0] + self.player.hitbox[2] > 1000 and self.player.droite and self.scroll[0] + 1067 < self.drapeau.x:
